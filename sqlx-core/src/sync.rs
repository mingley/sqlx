...
pub use tokio::sync::{
    Mutex as AsyncMutex,
    MutexGuard as AsyncMutexGuard, OwnedMutexGuard as AsyncMutexGuardArc, RwLock as AsyncRwLock};

#[cfg(all(feature = "_rt-async-lock", not(feature = "_rt-tokio")))]
pub use async_lock::{Mutex as AsyncMutex, MutexGuard as AsyncMutexGuard, MutexGuardArc as AsyncMutexGuardArc, RwLock as AsyncRwLock};
